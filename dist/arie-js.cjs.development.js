...
var useArieCursor = function useArieCursor(touchEnabled, selectedElementId, selectedElementOffset) {
  ...
  var _React$useState = React.useState(initArie),
...
var PointerValue = function PointerValue() {
  var _React$useState = React.useState('arie.js'),
   ...
   *
   */
  return React.createElement(DataString, null, React.createElement("span", null, value));
};
/**
 *
 * @returns {component}.
...
var ScrollValue = function ScrollValue() {
   ...
   * default is 'traxx©'
   */
  var _React$useState = React.useState('traxx©'),
    value = _React$useState[0],
    setValue = _React$useState[1];
  React.useEffect(function () {
    /**
...
exports.useArieCursor = useArieCursor$1;
exports.useArieScroll = useArieScroll;
